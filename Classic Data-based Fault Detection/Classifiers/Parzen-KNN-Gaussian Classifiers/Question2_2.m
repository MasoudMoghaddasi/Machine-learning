...
for h=1:size(H,2)
    Class_Out(h,:)=Parzen_classifier(XtrainAll',Xtest',ClassVector_train,H(h));
    for n=1:10
...
class_Out=Parzen_classifier(XtrainAll',Xvalidation',ClassVector_train,H_opt);
...
confidence
save('result2_3_parzen','H_opt','confidence')