...
X_Train_All = {  X_train_n , X_train_f16 , X_train_f17 , X_train_f18 } ;
X_Test_All = { X_test_n , X_test_f16 , X_test_f17 , X_test_f18 } ;
...
title('Fishet Criteria Vs. Dimention')
...
if d==3
    ...
    hold on
    plot3(Z_train{4}(1,:),Z_train{4}(2,:),Z_train{4}(3,:),'k^')
    hold off
    grid on
...
elseif d==2
    ...
    hold on
    plot(Z_train{4}(1,:),Z_train{4}(2,:),'k^')
    hold off
    grid on
legend('First Class','Second Class','Third Class','Fourth Class');
title('Train Features After PCA')
...
if d==3
    ...
    hold on
    plot3(Z_test{4}(1,:),Z_test{4}(2,:),Z_test{4}(3,:),'k^')
    hold off
    grid on
    legend('First Class','Second Class','Third Class','Fourth Class');
